...
from model.resnet import resnet34, resnet101, load, save
...
class service:
    def __init__(self, model_name, weight_path, label2name_path) -> None:
        ...
        missing_keys, unexpected_keys = self.model.load_state_dict(torch.load(weight_path,map_location=torch.device('cpu')), strict=False)
        self.get_transform()
...
if __name__ == "__main__":
    model_service = service(model_name="resnet34",
                            weight_path="../model_weight/restnet0.8235_.pt",
